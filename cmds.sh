ssh 127.0.0.1 "set +o bgnice; cd /home/weihai/janus;  ulimit -n 20000;  mkdir -p /home/weihai/janus/log;  nohup taskset -ac 0-15 ./build/deptran_server -b -d 30 -n 300 -f 'par-dist/leader_multi_paxos16_1.yml' -f 'config/tpl_ww_paxos.yml' -f 'config/rw.yml' -P 'c1_0' -p 5555 -t 10 -r '/home/weihai/janus/log' 1>'/home/weihai/janus/log/proc-c1_0.log' 2>'/home/weihai/janus/log/proc-c1_0.err' &"
sleep 0.1
